...
1. Démarrer avec `npm run server` (Node.js 22.13 minimum).
...
6. Consulter la cloche pour les notifications internes ; ouvrir un élément marque sa
   lecture et affiche l’alerte correspondante.
